...
//       destinationGoogle: this.props.navigation.state.params.destination,
//       destinationLocation : [],
//       numberToCall : 112,
//       number: 1,
//
...
//          });
//          //TESTARRRRRRRRR
//          // return fetch('https://maps.googleapis.com/maps/api/geocode/json?address=' + this.state.destinationGoogle + '&key=AIzaSyAprDH-yXK21Imj4qwj0zyKbzAdWHTom9M')
...
//
// 	render() {
//     console.log("testmain", this.state.destinationGoogle)
//     console.log('https://maps.googleapis.com/maps/api/geocode/json?address=' + this.state.destinationGoogle + '&key=AIzaSyAprDH-yXK21Imj4qwj0zyKbzAdWHTom9M')
